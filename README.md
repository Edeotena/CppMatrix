...
Реализация класса S21Matrix. Это не первый проект реализации матрицы, но его основное отличие - соблюдение (по крайней мере попытка) Google Style и других основ написания хорошего кода (правило пяти и т.д.)

### Как устроен класс матрицы проекта
...
### Реализованные конструкторы и деструкторы
